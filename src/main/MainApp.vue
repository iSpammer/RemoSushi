      ...
      <div class="container">
        <div class="site-header-inner">
          <div class="brand header-brand">
            <h1 class="m-0">
              <a href="#">
                                  <img width="32" height="32" src="../assets/svgs/sushiicon.svg" alt srcset />

                  <title>RemoSushi!</title>
      ...
      <section class="hero">
        <div class="container">
          <div class="hero-inner">
            <div class="hero-copy">
              <h1 class="hero-title mt-0 is-revealing">Remo Sushi Shop!</h1>
              <p
                class="hero-paragraph is-revealing"
              >love and sushi are a lot alike. you can never have too much of either.</p>
              <div class="hero-form field field-grouped is-revealing">
                <div class="control control-expanded">
                  <input class="input" type="email" name="email" placeholder="Email Address" />
                </div>
                <div class="control">
                  <a class="button button-primary button-block" href="#">Order</a>
                </div>
              </div>
            </div>
            <div class="hero-illustration">
              ...
              <div class="hero-square hero-square-1 is-moving-object is-rotating">
                <img width="200" height="200" src="../assets/svgs/sushi1.svg" alt srcset />
              </div>
              <div class="hero-square hero-square-2 is-moving-object is-rotating">
                <img width="88" height="88" src="../assets/svgs/sushi2.svg" alt srcset />
              </div>
              <div class="hero-square hero-square-3 is-moving-object is-rotating">
                <img width="88" height="88" src="../assets/svgs/sushi3.svg" alt srcset />
              </div>
              <div class="hero-square hero-square-4 is-moving-object is-rotating">
                <img width="320" height="320" src="../assets/svgs/sushi4.svg" alt srcset />
              </div>
              <div class="hero-square hero-square-5 is-moving-object is-rotating">
                                <img width="141" height="141" src="../assets/svgs/sushi5.svg" alt srcset />

              </div>
              <div class="hero-square hero-square-6 is-moving-object is-rotating">
                                <img width="128" height="128" src="../assets/svgs/sushi6.svg" alt srcset />

              </div>
              <div class="hero-square hero-square-7 is-moving-object is-rotating">
                                                <img width="70" height="70" src="../assets/svgs/sushi7.svg" alt srcset />

              </div>
              <div class="hero-square hero-square-8 is-moving-object is-rotating">
                                                                <img width="40" height="40" src="../assets/svgs/sushi8.svg" alt srcset />
            ...
            <div class="features-wrap">
              <div class="feature">
                <div class="feature-inner">
                  ...
                  <p class="text-sm mb-0">A Big Range of homemade sushi with excelent price tag</p>
                </div>
              </div>
              <div class="feature">
                <div class="feature-inner">
                  <div class="feature-header mb-16">
                    ...
                    <h4 class="feature-title m-0">Order</h4>
                  </div>
                  <p
                    class="text-sm mb-0"
                  >Choose any number of susho you want anytype you want no menu constraints!</p>
                </div>
              </div>
              <div class="feature">
                <div class="feature-inner">
                  <div class="feature-header mb-16">
                    ...
                    <h4 class="feature-title m-0">Deliver</h4>
                  </div>
                  <p
                    class="text-sm mb-0"
                  >Wait for our courier to come and deliver your order for you!</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <footer class="site-footer">
      ...
      <div class="container">
        <div class="site-footer-inner has-top-divider">
          <div class="footer-copyright">&copy; 2020 Remo Sushi, all rights reserved</div>
